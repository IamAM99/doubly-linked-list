...
TEST(APHW3Test, LinkedListCopyConstructor) {
...
TEST(APHW3Test, LinkedListSides) {
    LinkedList l1;
...
TEST(APHW3Test, LinkedListExtend) {
    LinkedList l1;
    LinkedList l2;
    l1.extend(l2);
    l1.show();      //
...
TEST(APHW3Test, LinkedListBracket) {
    LinkedList l1;
...
TEST(APHW3Test, LinkedListMainNodes) {
    LinkedList l2{1, 2, 3, 4, 5, 6, 7, 8, 9};
...
TEST(APHW3Test, LinkedListOthers) {
    LinkedList l1;
